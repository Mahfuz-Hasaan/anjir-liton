...
const ShishuAcademy = () => {
    ...
    return (
      ...
      <div>
        <div
          data-aos="fade-left"
          className="flex lg:flex-row flex-col justify-center items-center gap-20 px-3"
        >
          <div className="space-y-6 text-white lg:w-4/12">
          ...
          <img className="lg:w-4/12" src={sisuacadamy} alt="" />
        </div>
      </div>
    </div>
    );
